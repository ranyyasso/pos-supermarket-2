...
export function OfferSettings({saveAction,value,onSave,approve,onDirtyChange}:{saveAction?: {current: ((done:()=>void)=>void) | null};onDirtyChange:(dirty:boolean)=>void;value:SalesSettings;onSave:(value:SalesSettings)=>void;approve:(title:string,run:()=>void)=>void}) {
