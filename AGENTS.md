...
Fresh category decision (2026-09-19): Do not seed production with built-in categories. A fresh Supabase database starts with only the virtual Favorites slot; owner-created categories must come from Supabase and must not return after deletion.

Thermal print alignment decision (2026-09-19): Keep the selected 58/80 mm page width but inset receipt content by 3 mm on both physical edges during printing. This protects both edges from printer-driver offsets and brings receipt columns closer together.
